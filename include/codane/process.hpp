...
struct ProcessResult {int exit_code=-1,signal=0; std::string stdout_text,stderr_text; bool stdout_truncated=false,stderr_truncated=false,cancelled=false; std::chrono::milliseconds duration{0};};
